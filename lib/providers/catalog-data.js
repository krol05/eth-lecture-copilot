...
(function (root, factory) {
  ...
  const CATALOG_MODELS = {
    ...
    openrouter: [
      ...
      { id: "deepseek/deepseek-v4-pro-0813",         label: "DeepSeek V4 Pro 0813" },
      { id: "x-ai/grok-4.6",                         label: "Grok 4.6" },
      { id: "bytedance-seed/seed-2-1-turbo",         label: "Seed 2.1 Turbo" },
      { id: "qwen/qwen3.8-2.4t-a95b",                label: "Qwen3.8 2.4T A95B" },
    ...
    groq: [
      ...
      { id: "openai/gpt-oss-safeguard-20b", label: "Safety GPT OSS 20B" },
    ...
    mistral: [
      ...
      { id: "mistral-medium-2604",      label: "Mistral Medium 3.5" },
    ...
    cerebras: [
      ...
      { id: "gemma-4-31b",  label: "Gemma 4 31B IT" }
    ],
    perplexity: [
    ...
    fireworks: [
      ...
      { id: "accounts/fireworks/models/deepseek-v4-pro-0813",           label: "DeepSeek V4 Pro 0813" },
      { id: "accounts/fireworks/models/nemotron-lightning-3p5-30b-a3b", label: "Nemotron 3.5 Lightning 30B A3B" },
      { id: "accounts/fireworks/models/muse-glimmer-30b",               label: "Muse Glimmer 30B" },
      { id: "accounts/fireworks/models/qwen3p8-max",                    label: "Qwen3.8 Max" },
      { id: "accounts/fireworks/models/deepseek-v4-flash-0731",         label: "DeepSeek V4 Flash 0731" },
      { id: "accounts/fireworks/routers/kimi-k3-fast",                  label: "Kimi K3 Fast" },
      ...
      { id: "accounts/fireworks/models/qwen3p7-plus",                   label: "Qwen 3.7 Plus" },
    ...
    huggingface: [
      ...
      { id: "XiaomiMiMo/MiMo-V2.5-Pro",                      label: "MiMo-V2.5-Pro" },
      { id: "Qwen/Qwen3.6-27B",                              label: "Qwen3.6 27B" },
      { id: "moonshotai/Kimi-K2.6",                          label: "Kimi-K2.6" },
