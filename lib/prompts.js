...
{
  "deckTitle": "string — short descriptive name for this card set (3–8 words). Topic-focused label for an Anki sub-deck, e.g. 'Locks & Deadlocks', 'OpenMP Task Scheduling', 'Memory Consistency Models'. Do NOT repeat the course name. No lecture numbers unless essential.",
  "flashcards": [
    {
...
RULES:
- deckTitle is REQUIRED — one concise name summarizing what this lecture's cards cover.
