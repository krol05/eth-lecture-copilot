...
(function () {
  ...
  const KEY = 'eth-copilot-print-summary';
  ...
  function run() {
    ...
    document.title = (payload.title || 'Lecture summary').slice(0, 120);
    ...
    h1.textContent = payload.title || 'Lecture summary';
    ...
    body.className = 'print-body export-summary-body';
    body.innerHTML = payload.bodyHtml || '';
    root.appendChild(body);

    const footer = document.createElement('footer');
    footer.className = 'print-footer';
    footer.textContent = 'ETH Lecture Copilot — lecture summary export (KaTeX rendered)';
